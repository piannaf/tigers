...
<c:set var="title_key" value="Sampler List for Exceedance Reports"/>
<c:set var="page_description" value="Select a sampler from the map below to view exceedance reports for the sampler."/>
<c:set var="target_url" value="reportexceedance.html"/>
        ...
        function initialize() {    
            ...
            GEvent.addListener(mmap, 'click', function(marker) {
                if(marker && marker.getIcon) {    // check whether it's really a marker
                        var html = "reportexceedance.html?tag=" + marker.title;
