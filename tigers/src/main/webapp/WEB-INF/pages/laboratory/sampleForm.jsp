...
<ul>  
    ...
    <li>         
        ...
        <form:input  path="date_taken" id="date_taken" disabled="true" cssClass="text medium"/>
    ...
    <li>         
        ...
        <form:select path="sampler.laboratory" id="laboratory" disabled="true" cssClass="text medium">
    ...
    <li>         
        ...
        <form:errors path="sampler" cssClass="fieldError"/>         
        <form:select path="sampler.id" id="sampler" disabled="true" cssClass="text medium">
            <form:option value="" label="Select" />
