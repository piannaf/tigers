 ...
 */
public class ViewAvailableLaboratoriesController implements Controller {
    private transient final Log log = LogFactory.getLog(ViewAvailableLaboratoriesController.class);
