...
public class Sampler extends BaseObject {
	...
	public Map<String, Object> list_all_params() {
	    ...
	    allParams.put("Contractor", contractor == null ? null : contractor.getCompanyName());
	    ...
	    allParams.put("Laboratory", laboratory == null ? null : laboratory.getCompanyName());
	    allParams.put("License", license);
	    allParams.put("Purpose", purpose);
	    allParams.put("Water Body", waterbody == null ? null : waterbody.getName());
