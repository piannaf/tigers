...
<head>
    ...
    <meta name="heading" content="<fmt:message key='laboratoryList.heading'/>"/>
...
<display:table name="userList" cellspacing="0" cellpadding="0" requestURI="" 
    ...
    <display:column property="username" escapeXml="true" sortable="true" titleKey="user.username" style="width: 25%"
       url="../userinfo.html"  paramId="id" paramProperty="id"/>
    ...
    <display:column titleKey="user.drop" style="width: 16%; padding-left: 15px" media="html" 
        url="droplaboratory.html" paramId="id" paramProperty="id">
