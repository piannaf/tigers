...
<head>
    <title><fmt:message key="contractorList.title"/></title>
    <meta name="heading" content="<fmt:message key='contractorList.heading'/>"/>
...
url="/officer/addcontractor.html" paramId="id" paramProperty="id"/>
